...
class FSCCNet:
    def __init__(self, configuration: HiDDenConfiguration, device: torch.device, noiser: Noiser, tb_logger):
        ...
        self.adversarial_weight = configuration.adversarial_loss
        self.mse_weight = configuration.mse_weight
        self.ssim_weight = configuration.ssim_weight
        self.decode_weight = configuration.decode_weight
        print(self.adversarial_weight)
        print(self.mse_weight)
        print(self.ssim_weight)
        print(self.decode_weight)
